...
class _WebViewScreenState extends State<WebViewScreen> {
  final controllers.WebViewController _webViewController = controllers.WebViewController();
  ...
  void _updateSelectedTabFromUrl(String url) {
    ...
    if (normalizedUrl.contains('/transactions')) {
      matchedIndex = 1;
    } else if (normalizedUrl.contains('/decisionmaking') || normalizedUrl.contains('/ai')) {
      matchedIndex = 2;
                ...
                child: InAppWebView(
                  ...
                  shouldOverrideUrlLoading: (controller, navigationAction) async {
                    ...
                    if (uri != null) {
                      ...
                      if (urlString.contains('from_url=') && !urlString.contains('/login')) {
                        // User successfully logged in, extract the from_url and navigate there
                        var fromUrl = Uri.parse(uri.toString()).queryParameters['from_url'];
                        if (fromUrl != null) {
                          Future.delayed(const Duration(milliseconds: 500), () {
                            controller.loadUrl(urlRequest: URLRequest(url: WebUri(fromUrl)));
                          });
                        }
                      }
                    }
                  ...
                  onProgressChanged: (controller, progress) {
                    ...
                    setState(() {
                      _webViewController.updateProgress(progress.toDouble());
                    });
                  },
